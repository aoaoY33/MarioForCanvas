...
lib.ssMetadata = [
		{name:"mriao_atlas_1", frames: [[0,0,700,400],[366,477,58,59],[433,402,59,59],[426,524,58,59],[433,463,59,59],[0,538,58,59],[60,538,58,59],[0,477,59,59],[120,538,58,59],[61,477,59,59],[180,538,58,59],[240,538,58,59],[122,477,59,59],[300,538,58,59],[183,477,59,59],[360,538,58,59],[486,524,58,59],[244,477,59,59],[494,402,58,59],[305,477,59,59],[494,463,58,59],[546,524,36,48],[0,402,431,73],[420,585,24,32],[554,470,28,30],[554,436,32,32],[554,402,34,32],[546,574,26,32]]}
];
...
(lib.bg = function() {
	this.initialize(ss["mriao_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,0,1.6265,1);
...
(lib.MarioUser = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	props.startPosition = startPosition;
	props.labels = {stop:0,run:1,del:8};
	props.loop = loop;
	props.reversed = reversed;
	cjs.MovieClip.apply(this,[props]);
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(7).call(this.frame_7).wait(1).call(this.frame_8).wait(21));
	...
	this.instance_1.setTransform(-16,-17);

	this.instance_2 = new lib.run2();
	this.instance_2.setTransform(-16,-17);

	this.instance_3 = new lib.run3();
	this.instance_3.setTransform(-16,-17);

	this.instance_4 = new lib.run4();
	this.instance_4.setTransform(-16,-17);

	this.instance_5 = new lib.c02();
	this.instance_5.setTransform(-31,-30);

	this.instance_6 = new lib.c03();
	this.instance_6.setTransform(-31,-30);

	this.instance_7 = new lib.c04();
	this.instance_7.setTransform(-31,-30);

	this.instance_8 = new lib.c05();
	this.instance_8.setTransform(-31,-30);

	this.instance_9 = new lib.c06();
	this.instance_9.setTransform(-31,-30);

	this.instance_10 = new lib.c07();
	this.instance_10.setTransform(-31,-30);

	this.instance_11 = new lib.c08();
	this.instance_11.setTransform(-31,-30);

	this.instance_12 = new lib.c09();
	this.instance_12.setTransform(-31,-30);

	this.instance_13 = new lib.c10();
	this.instance_13.setTransform(-31,-30);

	this.instance_14 = new lib.c11();
	this.instance_14.setTransform(-31,-30);

	this.instance_15 = new lib.c12();
	this.instance_15.setTransform(-31,-30);

	this.instance_16 = new lib.c13();
	this.instance_16.setTransform(-31,-30);

	this.instance_17 = new lib.c14();
	this.instance_17.setTransform(-31,-30);

	this.instance_18 = new lib.c15();
	this.instance_18.setTransform(-31,-30);

	this.instance_19 = new lib.c16();
	this.instance_19.setTransform(-31,-30);

	this.instance_20 = new lib.c17();
	this.instance_20.setTransform(-31,-30);

	this.instance_21 = new lib.c18();
	this.instance_21.setTransform(-31,-30);

	this.instance_22 = new lib.c19();
	this.instance_22.setTransform(-31,-30);

	this.instance_23 = new lib.c20();
	this.instance_23.setTransform(-31,-30);

	this.instance_24 = new lib.c21();
	this.instance_24.setTransform(-31,-30);
...
p.nominalBounds = new cjs.Rectangle(-31,-30,59,59);


// stage content:
(lib.mriao = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
// library properties:
lib.properties = {
	id: '4098A66B8D289840BFE95A1F288A68A3',
	width: 700,
	height: 400,
	fps: 30,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/mriao_atlas_1.png?1690992972546", id:"mriao_atlas_1"}
	],
	preloads: []
};
...
an.compositions['4098A66B8D289840BFE95A1F288A68A3'] = {
